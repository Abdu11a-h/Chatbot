        ...
        <div class="panel panel-primary">
          <div class="px-2" style="display: flex;justify-content:space-between;align-items: center;">
            <div class="panel-heading">
              <span class="glyphicon glyphicon-comment"></span> User Chat
            </div>
          ...
          <div class="panel-body">
            <ul class="chat" id="received">
              ...
              <?php foreach ($all_messages as $row) { ?>
                ...
                <li style="text-align: <?= $row->role == 'user' ? 'right' : 'left'; ?>">
                  <?= $row->message ?>
                </li>
              <?php } ?>
            </ul>
                ...
                <div class="col-md-12" id="msg_block">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button class="btn btn-warning btn-sm" id="submit" onclick="submitForm_to('<?php echo ADMINFUNCTIONS . 'add_message_user'; ?>','<?php echo ADMIN . 'index' ?>','add_form')">Send</button>
                    </span>
          ...
          success: function(data) {
            ...
            if (data.success) {
              ...
              for (var i = 0; i < messages.length; i++) {
                ...
                var li = $('<li></li>').css('text-align', message.role == 'user' ? 'right' : 'left').text(message.message);
                $('#received').append(li);
              }
            } else {
